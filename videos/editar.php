<?php require '../include/video.php'; $video = new Videos(); if( isset( $_GET['id'] ) ) $video->show( $_GET['id'] );?>
<!doctype html>
    ...
    <ul id="nav" class="dropdown dropdown-horizontal">
     ...
     <section id="mainContent">
			...
			<article>
             ...
             <table>
             	<tr><th>Vídeo</th><th>Acción</th></tr>
             <?php $i = 0;$videos = $video->all(1); ?>	                                   				      		 
              <?php foreach( $videos as $value ): $i++; ?>
                    ...
                    <tr>
                        ...
                        <td><a href="javascript: void(0);" onClick="javascript: if( confirm( 'Quiere eliminar este video?' )) window.location='eliminar.php?id=<?php echo $value['id'] ?>'; else return false;">Borrar</a></td>
                    </tr>
             ...
             <form id="form" action="" method="post" enctype="multipart/form-data">
                ...
                <?php if( !empty( $_FILES ) ): if( $video->edit( $_GET['id'] ) == true ): echo '<h1>El video se subio con exíto</h1><br>'; endif; ?>
             	<br>
